...
import com.wafitz.pixelspacebase.sprites.PlantSprite;
import com.wafitz.pixelspacebase.ui.AttackIndicator;
import com.wafitz.pixelspacebase.ui.Banner;
import com.wafitz.pixelspacebase.ui.BusyIndicator;
...
public class GameScene extends PixelScene {
	...
	private static final String TXT_WELCOME			= "Welcome to level %d of Pixel Spacebase!";
	private static final String TXT_WELCOME_BACK	= "Welcome back to level %d of Pixel Spacebase!";
	private static final String TXT_NIGHT_MODE		= "Be cautious, since the Spacebase is even more dangerous at night!";
	
	private static final String TXT_CHASM	= "Your steps echo across the Spacebase.";
	...
	public void create() {
		...
		super.create();
		Camera.main.zoom( defaultZoom + PixelSpacebase.zoom() );
		...
		brightness( PixelSpacebase.brightness() );
