...
public enum HeroSubClass {
	...
	BERSERKER( "Admiral",
		"When severely wounded, the _Admiral_ enters a state of wild fury " +
	...
	BATTLEMAGE( "DM3002",
		"When fighting with a wand in his hands, the _DM3002_ inflicts additional damage depending " +
		"on the current number of charges. Every successful hit restores 1 charge to this wand." ),
	
	ASSASSIN( "Blob",
		"When performing a surprise attack, the _Blob_ inflicts additional damage to his target." ),
	FREERUNNER( "Changling",
		"The _Changling_ can move almost twice faster, than most of the monsters. When he " +
