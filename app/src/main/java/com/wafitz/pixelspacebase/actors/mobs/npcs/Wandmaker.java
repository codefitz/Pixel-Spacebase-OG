...
import com.wafitz.pixelspacebase.items.quest.PhantomFish;
...
import com.wafitz.pixelspacebase.sprites.WandmakerSprite;
import com.wafitz.pixelspacebase.utils.Utils;
import com.wafitz.pixelspacebase.windows.WndQuest;
import com.wafitz.pixelspacebase.windows.WndWandmaker;
				...
				switch (Random.Int( 3 )) {
					...
					case 2:
						...
						for (int i = 0; i < Dungeon.level.length(); i++) {
							if (Level.water[i]) {
								if (++water > Dungeon.level.length() / 16) {
