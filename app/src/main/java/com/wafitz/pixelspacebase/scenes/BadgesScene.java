...
public class BadgesScene extends PixelScene {
	...
	public void create() {
		...
		int pw = (int)Math.min( w, (PixelSpacebase.landscape() ? MIN_WIDTH_L : MIN_WIDTH_P) * 3 ) - 16;
		int ph = (int)Math.min( h, (PixelSpacebase.landscape() ? MIN_HEIGHT_L : MIN_HEIGHT_P) * 3 ) - 32;
