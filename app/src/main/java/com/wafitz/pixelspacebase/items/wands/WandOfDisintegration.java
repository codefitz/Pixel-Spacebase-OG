...
import com.wafitz.pixelspacebase.effects.DeathRay;
...
public class WandOfDisintegration extends Wand {
	...
	protected void fx( int cell, Callback callback ) {
		...
		Item.curUser.sprite.parent.add( new DeathRay( Item.curUser.sprite.center(), DungeonTilemap.tileCenterToWorld( cell ) ) );
		callback.call();
	}
